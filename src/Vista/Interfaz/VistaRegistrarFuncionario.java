...
import Controlador.ControladorRegistrarFuncionario;
import Vista.ImagenFondo;

public class VistaRegistrarFuncionario extends JFrame {
    ...
    public VistaRegistrarFuncionario() {
        this.setTitle("EMPRESA SOCOSANI:   Registrar Funcionario");
    ...
    private void ComponentesVistaCompra() {
        ...
        String[] columnas = {"N° Registro", "Nombre", "Apellido", "DNI", "Direccion", "Puesto", "Telefono", "Correo", "Fecha Registro"};
        ...
        ControladorInterfaz.agregarEtiqueta(PanelVistaCompra, "Puesto:", new Font("Aptos Black", Font.BOLD, 20), 10, 255, 430, 25);
        puestoField = ControladorInterfaz.agregarCampoTexto(PanelVistaCompra, new Font("Aptos Black", Font.PLAIN, 20), 5, 280, 550, 35);
        ...
        registrarButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ControladorRegistrarFuncionario.registrarFuncionario(model, nombreField, apellidoField, dniField, direccionField, puestoField, telefonoField, correoField);
            }
        });
        ...
        guardarButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                ControladorRegistrarFuncionario.guardarDatosFuncionario(model);
            }
        });
